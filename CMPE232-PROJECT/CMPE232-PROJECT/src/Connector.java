...
public class Connector {
	...
	static final String USER = "ticketix";
	static final String PASS = "ticketix";
	...
	public static void displayCC(Connection conn) {
		...
		try{
			...
			while(!rs.isAfterLast()) {
				...
				System.out.println(rs.getString("CARD_ID")+" | "+rs.getString("BALANCE")+" | "+rs.getString("CUSTOMER_CARD_ID"));
